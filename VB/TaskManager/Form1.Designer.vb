Namespace TaskManager
    Partial Public Class Form1
        ...
        Private Sub InitializeComponent()
            ...
            DirectCast(Me.splitContainerControl, System.ComponentModel.ISupportInitialize).BeginInit()
            ...
            DirectCast(Me.xpTasks, System.ComponentModel.ISupportInitialize).BeginInit()
            DirectCast(Me.xpPersons, System.ComponentModel.ISupportInitialize).BeginInit()
            ...
            ' 
            Me.navbarImageListLarge.ImageStream = (DirectCast(resources.GetObject("navbarImageListLarge.ImageStream"), System.Windows.Forms.ImageListStreamer))
            ...
            ' navbarImageList
            ' 
            Me.navbarImageList.ImageStream = (DirectCast(resources.GetObject("navbarImageList.ImageStream"), System.Windows.Forms.ImageListStreamer))
            ...
            timeRuler2.TimeZoneId = "Pacific Standard Time"
            ...
            ' schedulerStorage
            ' 
            Me.schedulerStorage.Appointments.DataSource = Me.xpTasks
            Me.schedulerStorage.Appointments.Mappings.AllDay = "AllDay"
            Me.schedulerStorage.Appointments.Mappings.AppointmentId = "TaskId"
            ...
            Me.schedulerStorage.Appointments.Mappings.ResourceId = "PersonId!Key"
            ...
            Me.schedulerStorage.Resources.DataSource = Me.xpPersons
            Me.schedulerStorage.Resources.Mappings.Caption = "Name"
            Me.schedulerStorage.Resources.Mappings.Color = "Color"
            Me.schedulerStorage.Resources.Mappings.Id = "PersonId"
            Me.schedulerStorage.Resources.Mappings.Image = "Image"
            ' 
            ' xpTasks
            ' 
            Me.xpTasks.DeleteObjectOnRemove = True
            Me.xpTasks.ObjectType = GetType(TaskManager.TaskDatabase.Task)
            ' 
            ' xpPersons
            ' 
            Me.xpPersons.ObjectType = GetType(TaskManager.TaskDatabase.Person)
            ' 
            ' dateNavigator
            ' 
            ...
            Me.Text = "Form1"
            DirectCast(Me.splitContainerControl, System.ComponentModel.ISupportInitialize).EndInit()
            ...
            DirectCast(Me.xpTasks, System.ComponentModel.ISupportInitialize).EndInit()
            DirectCast(Me.xpPersons, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        Private xpTasks As DevExpress.Xpo.XPCollection
        Private xpPersons As DevExpress.Xpo.XPCollection
