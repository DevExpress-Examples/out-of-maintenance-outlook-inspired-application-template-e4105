...
Namespace TaskManager
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			CType(Me.xpTasks, System.ComponentModel.ISupportInitialize).BeginInit()
			CType(Me.xpPersons, System.ComponentModel.ISupportInitialize).BeginInit()
			...
			Me.schedulerControl.Start = New System.DateTime(2012, 6, 18, 0, 0, 0, 0)
			...
			timeRuler1.TimeZone.DaylightZoneName = "Pacific Daylight Time"
			timeRuler1.TimeZone.DisplayName = "(UTC-08:00) Pacific Time (US & Canada)"
			timeRuler1.TimeZone.StandardDate = New System.DateTime(1, 11, 1, 2, 0, 0, 0)
			timeRuler1.TimeZone.StandardZoneName = "Pacific Standard Time"
			...
			timeRuler2.TimeZone.DaylightZoneName = "Pacific Daylight Time"
			timeRuler2.TimeZone.DisplayName = "(UTC-08:00) Pacific Time (US & Canada)"
			timeRuler2.TimeZone.StandardDate = New System.DateTime(1, 11, 1, 2, 0, 0, 0)
			timeRuler2.TimeZone.StandardZoneName = "Pacific Standard Time"
			...
			CType(Me.xpTasks, System.ComponentModel.ISupportInitialize).EndInit()
			CType(Me.xpPersons, System.ComponentModel.ISupportInitialize).EndInit()
